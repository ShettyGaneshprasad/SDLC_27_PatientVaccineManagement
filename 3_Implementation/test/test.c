...
void test_insert(void)
{
    ...
    TEST_ASSERT_EQUAL(SUCCESS, insert_patientrecord(start, id, firstname, lastname, aadhar_num, height, weight, age, date, insurance, shot));
    fseek(f, 0, SEEK_END);
    fwrite(&id, 4, 1, f);
...
void check_uniq_id(void)
{
    ...
    insurance = 0;
    shot = 1;
    (start, id, firstname, lastname, aadhar_num, height, weight, age, date, insurance, shot);
    fseek(f, 0, SEEK_END);
    fwrite(&id, 4, 1, f);
